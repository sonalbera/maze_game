...
//	output(70,40,"(Assistant Professor,Dept. of CSE)");
 ...
 void winscreen()
 {
	...
	output(15,100,"YOU HAVE SUCCEEDED ");
	 output(35,60,"* PRESS ESC TO GO TO MAIN MENU");
     output(35,45,"* PRESS 1 TO RESTART ");
	glFlush();
 }
void startscreen()
{
...
void instructions()
{
  glClear(GL_COLOR_BUFFER_BIT);
	...
	glEnd();
	glColor3f(0,1,0);
  output(-20,120,"*  MOVE THE POINT USING ARROW KEYS");
  output(-20,100,"* FIND THE WAY TO MOVE INTO THE MAZE AND GET OUT");
  output(-20,80,"* GREEN  POINT INDICATE THE POINT FROM WHERE YOU HAVE TO START");
  output(-20,60,"* RED  POINT INDICATE THE POINT WHERE YOU HAVE TO REACH");
...
void timeover()
{
 glClear(GL_COLOR_BUFFER_BIT);
 glColor3f(0,0,1.0);
 output(70,110,"TIMEUP");
 glColor3f(0,1,0);
 output(50,100,"YOU  LOST THE GAME");
